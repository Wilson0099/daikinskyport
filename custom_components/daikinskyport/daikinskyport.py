...
#        self.update()
    ...
    def get_sensors(self, index):
        ...
        sensors.append({"name": f"{name} Outdoor", "value": thermostat['ctOutdoorFanRPM'], "type": "score"})
        sensors.append({"name": f"{name} Outdoor", "value": thermostat['ctTargetODFanRPM'], "type": "score"})
        sensors.append({"name": f"{name} Outdoor", "value": thermostat['ctCurrentCompressorRPS'], "type": "score"})
        sensors.append({"name": f"{name} Outdoor", "value": thermostat['ctTargetCompressorspeed'], "type": "score"})
        sensors.append({"name": f"{name} Outdoor", "value": thermostat['quietModeActive'], "type": "score"})
        sensors.append({"name": f"{name} Outdoor", "value": thermostat['ctOutdoorQuietModeEnabled'], "type": "score"})
        sensors.append({"name": f"{name} Outdoor", "value": thermostat['ctOutdoorNoiseDownLevel'], "type": "score"})

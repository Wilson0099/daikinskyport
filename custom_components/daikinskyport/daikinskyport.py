...
#        self.update()
    ...
    def get_sensors(self, index):
        ...
        sensors.append({"name": f"{name} Indoor", "value": thermostat['ctOutdoorFanRPM'], "type": "score"})
        sensors.append({"name": f"{name} Indoor", "value": thermostat['ctTargetODFanRPM'], "type": "score"})
        sensors.append({"name": f"{name} Indoor", "value": thermostat['ctCurrentCompressorRPS'], "type": "score"})
        sensors.append({"name": f"{name} Indoor", "value": thermostat['ctTargetCompressorspeed'], "type": "score"})
        sensors.append({"name": f"{name} Indoor", "value": thermostat['quietModeActive'], "type": "score"})
        sensors.append({"name": f"{name} Indoor", "value": thermostat['ctOutdoorQuietModeEnabled'], "type": "score"})
        sensors.append({"name": f"{name} Indoor", "value": thermostat['ctOutdoorNoiseDownLevel'], "type": "score"})
